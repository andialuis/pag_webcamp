...
<section class="seccion contenedor">
  ...
  <form id="registro" class="registro" action="pagar.php" method="post">
    <div id="datos_usuario" class="registo caja clearfix">
      <div class="campo">
        ...
        <li>
          ...
          <div class="tabla-precio">
            ...
            <div class="orden">
              ...
              <input type="number" min="0" id="pase_dosdias" size="3" placeholder="0" name="boletos[2dias][cantidad]">
   ...
   <div id="resumen" class="resumen clearfix">
    ...
    <div class="caja clearfix">
      <div class="extras">
        <div class="orden">
          <label for="camisa_evento">Camisa del evento $10 <small>(promocion 7% dcto)</small></label>
        ...
        <div class="orden">
          ...
          <select id="regalo" name ="regalo" required="">
            <option Value="">Seleccione regalo</option>
            <option Value="2">etiquea</option>
      ...
      <div class="total">
        ...
        <input type="submit" id="btnRegistro" class="button" value="Pagar" name="submit">
      </div><!-- total -->
    </div><!-- caja -->
  </div><!-- resumen -->
